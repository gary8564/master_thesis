...
df1.to_csv('kobe_ccwtarx(predict)_lstm.csv', index=False, header=False)
d2 ={'Eigth':rel_eighth1, 'Fifth':rel_fifth1,
     'Third':rel_third1,'First':rel_first1, 'Input':test_input}
df2 = pd.DataFrame(data=d2)
df2.to_csv('kobe_ccwtarx(real)_lstm.csv', index=False, header=False)

#%% save results
model.save("lstm_future_predict_past.h5")
