# -*- coding: utf-8 -*-
"""
Created on Sun Aug  9 10:49:08 2020
...
def split_multisequence(sequences, n_steps):
	...
	for i in range(len(sequences)):
		...
		seq_x=[seq_x for seq_x in reversed(seq_x)]
		X.append(seq_x)
		y.append(seq_y)
...
np.save('trainX_lstm_futurepredpast',trainX)
np.save('trainy_lstm_futurepredpast',trainy)
