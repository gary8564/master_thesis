# -*- coding: utf-8 -*-
"""
Created on Sat Aug 22 10:10:08 2020
...
trainX = np.vstack((jiji_X,norica_X,mexico_X,berkeley_X,christchurch_X,christchurch11_X,jp311_X,
                    hualien19_X,amberley_X,nantou_X,hualien_X,california20_X,
                    hualien331_X,chile_X,chiayi_X,yilan_X,
                    rome_X,sakaria_X,athens_X,kocaeli_X,meinung_X,nantou602_X,
                    california19_X))
trainy = np.vstack((jiji_y,norica_y,mexico_y,berkeley_y,christchurch_y,christchurch11_y,jp311_y,
                    hualien19_y,amberley_y,nantou_y,hualien_y,california20_y,
                    hualien331_y,chile_y,chiayi_y,yilan_y,
                    rome_y,sakaria_y,athens_y,kocaeli_y,meinung_y,nantou602_y,
                   california19_y))
n_input = trainX.shape[1]
print('trainX:',trainX.shape)
print('trainy:',trainy.shape)
np.save('trainX_mlp_incomplete',trainX)
np.save('trainy_mlp_incomplete',trainy)
